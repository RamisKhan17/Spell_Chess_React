...
export default function King({ isRed }: PieceProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Cross Vertical */}
        <path fill="none" strokeLinejoin="miter" d="M22.5 11.6V6" />

        {/* Upper Loop / Cross Base */}
        <path
          fill={pieceColor}
          strokeLinecap="butt"
        ...
        {/* Cross Horizontal */}
        <path fill="none" strokeLinejoin="miter" d="M20 8h5" />
